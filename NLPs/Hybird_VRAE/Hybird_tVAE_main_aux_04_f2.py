...
flags.DEFINE_string('ckpt_path', './results/Hybird_tVAE/ckpt_aux04_f2_1/', '')
flags.DEFINE_string('logs_path', './results/Hybird_tVAE/logs_aux04_f2_1/', '')
...
flags.DEFINE_float('alpha', 0.4, '')  # 额外的重构误差的权重
